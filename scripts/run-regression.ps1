...
try {
    ...
    Write-Host "Backend tests: $BackendResult"
    Write-Host "Frontend tests: $FrontendResult"
    Write-Host "Contract tests: $ContractResult"
    Write-Host "Build: $BuildResult"
    Write-Host "Regression: $RegressionResult"
}
