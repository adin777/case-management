...
def run(*, include_demo_data: bool = False) -> None:
    with SessionLocal() as db:
        ...
        permission_names = {
            ...
            "sla.view": ("צפייה ב-SLA", "מאפשר צפייה בזמני השירות שהוגדרו"),
            "sla.configure": ("הגדרת SLA", "מאפשר יצירה ועריכה של יעדי תגובה ופתרון"),
            "sla.report": ("דוח SLA", "מאפשר צפייה וייצוא של דוח SLA"),
