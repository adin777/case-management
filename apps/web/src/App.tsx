...
export default function App(){return <AppErrorBoundary><Routes><Route path="/login" element={<LoginPage/>}/><Route path="/register" element={<RegisterPage/>}/><Route element={<Authenticated><AppLayout/></Authenticated>}><Route path="/" element={<DashboardPage/>}/><Route path="/cases" element={<Navigate to="/?tab=my" replace/>}/><Route path="/assigned" element={<Navigate to="/?tab=assigned" replace/>}/><Route path="/approvals/pending" element={<PendingApprovalsPage/>}/><Route path="/cases/new" element={<CreateCasePage/>}/><Route path="/cases/:id" element={<CaseDetailsPage/>}/><Route path="/implementer" element={<ImplementerStudioPage/>}/><Route path="/admin/environments" element={<EnvironmentsPage/>}/><Route path="/admin/request-types/:id" element={<FormBuilderPage/>}/><Route path="/admin/users" element={<UsersPage/>}/><Route path="/admin/user-fields" element={<UserFieldsPage/>}/><Route path="/admin/permissions" element={<PermissionsPage/>}/><Route path="/admin/case-values" element={<GlobalFieldsPage/>}/><Route path="/reports" element={<ReportsCenterPage/>}/><Route path="/reports/cases" element={<CaseReportPage/>}/><Route path="/reports/approvals" element={<ApprovalReportPage/>}/><Route path="/reports/users" element={<UsersPermissionsReportPage/>}/><Route path="/reports/audit" element={<AuditReportPage/>}/></Route></Routes></AppErrorBoundary>}
