...
import { Alert, Avatar, Box, Button, Card, CardContent, Chip, CircularProgress, Container, Divider, Grid, MenuItem, Paper, Stack, TextField, Typography } from '@mui/material';
...
export function CaseDetailsPage() {
  ...
  const currentStatus = item.status_label || statusLabel(item.status);
