...
export function buildWorkspaceQuery(filters: WorkspaceFilters, view: string, page: number, pageSize: number, sort: string, queue?: string) {
  ...
  if(queue)value.set('queue',queue);
