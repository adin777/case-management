...
export type GlobalField = { id: string; key: string; label_he: string; label_en: string; field_type: string; is_required: boolean; is_active: boolean; sort_order: number; semantic_binding?: string | null; options: GlobalOption[] };
