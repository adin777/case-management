...
export function GroupsTab({ groups, users, environments, onCreated }: { groups: Group[]; users: User[]; environments: Environment[]; onCreated: () => Promise<void> | void }) {
