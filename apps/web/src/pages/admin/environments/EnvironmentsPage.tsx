...
const labels = ['כללי', 'הגדרות קריאה', 'שדות הסביבה', 'משתמשים ושיוכים', 'אוטומציות', 'אישורים', 'SLA', 'ניהול ידע'];
